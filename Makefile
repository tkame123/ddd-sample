...
order.test.mock:
	...
	mockgen -destination=app/order_api/domain/port/mock/service.go -package=mock github.com/tkame123/ddd-sample/app/order_api/domain/port/service OrderService
