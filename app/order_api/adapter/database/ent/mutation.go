...
const (
	...
	// Node types.
	TypeCancelOrderSagaState = "CancelOrderSagaState"
...
// CancelOrderSagaStateMutation represents an operation that mutates the CancelOrderSagaState nodes in the graph.
type CancelOrderSagaStateMutation struct {
	config
	op            Op
	typ           string
	id            *uuid.UUID
	current       *cancelordersagastate.Current
	ticket_id     *uuid.UUID
	created_at    *time.Time
	updated_at    *time.Time
	clearedFields map[string]struct{}
	done          bool
	oldValue      func(context.Context) (*CancelOrderSagaState, error)
	predicates    []predicate.CancelOrderSagaState
}

var _ ent.Mutation = (*CancelOrderSagaStateMutation)(nil)

// cancelordersagastateOption allows management of the mutation configuration using functional options.
type cancelordersagastateOption func(*CancelOrderSagaStateMutation)

// newCancelOrderSagaStateMutation creates new mutation for the CancelOrderSagaState entity.
func newCancelOrderSagaStateMutation(c config, op Op, opts ...cancelordersagastateOption) *CancelOrderSagaStateMutation {
	m := &CancelOrderSagaStateMutation{
		config:        c,
		op:            op,
		typ:           TypeCancelOrderSagaState,
...
// withCancelOrderSagaStateID sets the ID field of the mutation.
func withCancelOrderSagaStateID(id uuid.UUID) cancelordersagastateOption {
	return func(m *CancelOrderSagaStateMutation) {
		var (
			err   error
			once  sync.Once
			value *CancelOrderSagaState
		)
		m.oldValue = func(ctx context.Context) (*CancelOrderSagaState, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().CancelOrderSagaState.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withCancelOrderSagaState sets the old CancelOrderSagaState of the mutation.
func withCancelOrderSagaState(node *CancelOrderSagaState) cancelordersagastateOption {
	return func(m *CancelOrderSagaStateMutation) {
		m.oldValue = func(context.Context) (*CancelOrderSagaState, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
func (m CancelOrderSagaStateMutation) Client() *Client {
...
func (m CancelOrderSagaStateMutation) Tx() (*Tx, error) {
...
// operation is only accepted on creation of CancelOrderSagaState entities.
func (m *CancelOrderSagaStateMutation) SetID(id uuid.UUID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *CancelOrderSagaStateMutation) ID() (id uuid.UUID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *CancelOrderSagaStateMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	switch {
	...
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().CancelOrderSagaState.Query().Where(m.predicates...).IDs(ctx)
	default:
...
func (m *CancelOrderSagaStateMutation) SetCurrent(c cancelordersagastate.Current) {
	m.current = &c
}

// Current returns the value of the "current" field in the mutation.
func (m *CancelOrderSagaStateMutation) Current() (r cancelordersagastate.Current, exists bool) {
	v := m.current
	if v == nil {
		return
	}
...
// OldCurrent returns the old "current" field's value of the CancelOrderSagaState entity.
// If the CancelOrderSagaState object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CancelOrderSagaStateMutation) OldCurrent(ctx context.Context) (v cancelordersagastate.Current, err error) {
...
func (m *CancelOrderSagaStateMutation) ResetCurrent() {
	m.current = nil
}

// SetTicketID sets the "ticket_id" field.
func (m *CancelOrderSagaStateMutation) SetTicketID(u uuid.UUID) {
	m.ticket_id = &u
}

// TicketID returns the value of the "ticket_id" field in the mutation.
func (m *CancelOrderSagaStateMutation) TicketID() (r uuid.UUID, exists bool) {
	v := m.ticket_id
	if v == nil {
		return
	}
...
// OldTicketID returns the old "ticket_id" field's value of the CancelOrderSagaState entity.
// If the CancelOrderSagaState object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CancelOrderSagaStateMutation) OldTicketID(ctx context.Context) (v *uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CancelOrderSagaStateMutation) ClearTicketID() {
	m.ticket_id = nil
	m.clearedFields[cancelordersagastate.FieldTicketID] = struct{}{}
}

// TicketIDCleared returns if the "ticket_id" field was cleared in this mutation.
func (m *CancelOrderSagaStateMutation) TicketIDCleared() bool {
	_, ok := m.clearedFields[cancelordersagastate.FieldTicketID]
	return ok
}

// ResetTicketID resets all changes to the "ticket_id" field.
func (m *CancelOrderSagaStateMutation) ResetTicketID() {
	m.ticket_id = nil
	delete(m.clearedFields, cancelordersagastate.FieldTicketID)
}

// SetCreatedAt sets the "created_at" field.
func (m *CancelOrderSagaStateMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *CancelOrderSagaStateMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the CancelOrderSagaState entity.
// If the CancelOrderSagaState object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CancelOrderSagaStateMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CancelOrderSagaStateMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *CancelOrderSagaStateMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *CancelOrderSagaStateMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the CancelOrderSagaState entity.
// If the CancelOrderSagaState object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CancelOrderSagaStateMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CancelOrderSagaStateMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// Where appends a list predicates to the CancelOrderSagaStateMutation builder.
func (m *CancelOrderSagaStateMutation) Where(ps ...predicate.CancelOrderSagaState) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the CancelOrderSagaStateMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *CancelOrderSagaStateMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.CancelOrderSagaState, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
func (m *CancelOrderSagaStateMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *CancelOrderSagaStateMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (CancelOrderSagaState).
func (m *CancelOrderSagaStateMutation) Type() string {
	return m.typ
}
...
// AddedFields().
func (m *CancelOrderSagaStateMutation) Fields() []string {
	fields := make([]string, 0, 4)
	if m.current != nil {
		fields = append(fields, cancelordersagastate.FieldCurrent)
	}
	if m.ticket_id != nil {
		fields = append(fields, cancelordersagastate.FieldTicketID)
	}
	if m.created_at != nil {
		fields = append(fields, cancelordersagastate.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, cancelordersagastate.FieldUpdatedAt)
	}
	return fields
}
...
// schema.
func (m *CancelOrderSagaStateMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// database failed.
func (m *CancelOrderSagaStateMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case cancelordersagastate.FieldCurrent:
	...
	return nil, fmt.Errorf("unknown CancelOrderSagaState field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CancelOrderSagaStateMutation) SetField(name string, value ent.Value) error {
	switch name {
	case cancelordersagastate.FieldCurrent:
		v, ok := value.(cancelordersagastate.Current)
		if !ok {
	...
	return fmt.Errorf("unknown CancelOrderSagaState field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *CancelOrderSagaStateMutation) AddedFields() []string {
	return nil
}
...
func (m *CancelOrderSagaStateMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CancelOrderSagaStateMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown CancelOrderSagaState numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *CancelOrderSagaStateMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(cancelordersagastate.FieldTicketID) {
		fields = append(fields, cancelordersagastate.FieldTicketID)
	}
	return fields
}
...
func (m *CancelOrderSagaStateMutation) FieldCleared(name string) bool {
...
func (m *CancelOrderSagaStateMutation) ClearField(name string) error {
	switch name {
	case cancelordersagastate.FieldTicketID:
		m.ClearTicketID()
		return nil
	}
	return fmt.Errorf("unknown CancelOrderSagaState nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *CancelOrderSagaStateMutation) ResetField(name string) error {
	switch name {
	case cancelordersagastate.FieldCurrent:
		m.ResetCurrent()
		return nil
...
func (m *CancelOrderSagaStateMutation) AddedEdges() []string {
...
func (m *CancelOrderSagaStateMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *CancelOrderSagaStateMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *CancelOrderSagaStateMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *CancelOrderSagaStateMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *CancelOrderSagaStateMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *CancelOrderSagaStateMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown CancelOrderSagaState unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *CancelOrderSagaStateMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown CancelOrderSagaState edge %s", name)
}
...
func withProcessedMessageID(id int) processedmessageOption {
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *ProcessedMessageMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ProcessedMessageMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
func (m *ProcessedMessageMutation) SetMessageID(s string) {
	m.message_id = &s
}

// MessageID returns the value of the "message_id" field in the mutation.
func (m *ProcessedMessageMutation) MessageID() (r string, exists bool) {
	v := m.message_id
	if v == nil {
		return
	}
...
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProcessedMessageMutation) OldMessageID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
