...
type callOrderCreateSagaWhenCardAuthorizationFailedHandler struct {
...
func NewCallOrderCreateSagaWhenCardAuthorizationFailedHandler(
	rep repository.Repository,
	orderSVC service.OrderService,
	kitchenAPI external_service.KitchenAPI,
	billingAPI external_service.BillingAPI,
) domain_event.EventHandler {
	return &callOrderCreateSagaWhenCardAuthorizationFailedHandler{
		rep:        rep,
		orderSVC:   orderSVC,
...
func (h *callOrderCreateSagaWhenCardAuthorizationFailedHandler) Handler(ctx context.Context, mes *message.Message) error {
