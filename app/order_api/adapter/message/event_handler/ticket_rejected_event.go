...
type callOrderCreateSagaWhenTicketRejectedHandler struct {
...
func NewCallOrderCreateSagaWhenTicketRejectedHandler(
	rep repository.Repository,
	orderSVC service.OrderService,
	kitchenAPI external_service.KitchenAPI,
	billingAPI external_service.BillingAPI,
) domain_event.EventHandler {
	return &callOrderCreateSagaWhenTicketRejectedHandler{
		rep:        rep,
		orderSVC:   orderSVC,
...
func (h *callOrderCreateSagaWhenTicketRejectedHandler) Handler(ctx context.Context, mes *message.Message) error {
