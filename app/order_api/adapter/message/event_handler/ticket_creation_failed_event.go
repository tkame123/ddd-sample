...
type callOrderCreateSagaWhenTicketCreationFailedHandler struct {
...
func NewCallOrderCreateSagaWhenTicketCreationFailedHandler(
	rep repository.Repository,
	orderSVC service.OrderService,
	kitchenAPI external_service.KitchenAPI,
	billingAPI external_service.BillingAPI,
) domain_event.EventHandler {
	return &callOrderCreateSagaWhenTicketCreationFailedHandler{
		rep:        rep,
		orderSVC:   orderSVC,
...
func (h *callOrderCreateSagaWhenTicketCreationFailedHandler) Handler(ctx context.Context, mes *message.Message) error {
