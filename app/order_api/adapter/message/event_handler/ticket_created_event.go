...
type callOrderCreateSagaWhenTicketCreatedHandler struct {
...
func NewCallOrderCreateSagaWhenTicketCreatedHandler(
	rep repository.Repository,
	orderSVC service.OrderService,
	kitchenAPI external_service.KitchenAPI,
	billingAPI external_service.BillingAPI,
) domain_event.EventHandler {
	return &callOrderCreateSagaWhenTicketCreatedHandler{
		rep:        rep,
		orderSVC:   orderSVC,
...
func (h *callOrderCreateSagaWhenTicketCreatedHandler) Handler(ctx context.Context, mes *message.Message) error {
