...
type callOrderCreateSagaWhenCardAuthorizedHandler struct {
...
func NewCallOrderCreateSagaWhenCardAuthorizedHandler(
	rep repository.Repository,
	orderSVC service.OrderService,
	kitchenAPI external_service.KitchenAPI,
	billingAPI external_service.BillingAPI,
) domain_event.EventHandler {
	return &callOrderCreateSagaWhenCardAuthorizedHandler{
		rep:        rep,
		orderSVC:   orderSVC,
...
func (h *callOrderCreateSagaWhenCardAuthorizedHandler) Handler(ctx context.Context, mes *message.Message) error {
