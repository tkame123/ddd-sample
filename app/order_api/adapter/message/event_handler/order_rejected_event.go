...
type callOrderCreateSagaWhenOrderRejectedHandler struct {
...
func NewCallOrderCreateSagaWhenOrderRejectedHandler(
	rep repository.Repository,
	orderSVC service.OrderService,
	kitchenAPI external_service.KitchenAPI,
	billingAPI external_service.BillingAPI,
) domain_event.EventHandler {
	return &callOrderCreateSagaWhenOrderRejectedHandler{
		rep:        rep,
		orderSVC:   orderSVC,
...
func (h *callOrderCreateSagaWhenOrderRejectedHandler) Handler(ctx context.Context, mes *message.Message) error {
