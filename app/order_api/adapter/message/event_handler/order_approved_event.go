...
type callOrderCreateSagaWhenOrderApprovedHandler struct {
...
func NewCallOrderCreateSagaWhenOrderApprovedHandler(
	rep repository.Repository,
	orderSVC service.OrderService,
	kitchenAPI external_service.KitchenAPI,
	billingAPI external_service.BillingAPI,
) domain_event.EventHandler {
	return &callOrderCreateSagaWhenOrderApprovedHandler{
		rep:        rep,
		orderSVC:   orderSVC,
...
func (h *callOrderCreateSagaWhenOrderApprovedHandler) Handler(ctx context.Context, mes *message.Message) error {
