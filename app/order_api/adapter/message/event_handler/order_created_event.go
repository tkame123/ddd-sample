...
type callOrderCreateSagaWhenOrderCreatedHandler struct {
...
func NewCallOrderCreateSagaWhenOrderCreatedHandler(
	rep repository.Repository,
	orderSVC service.OrderService,
	kitchenAPI external_service.KitchenAPI,
	billingAPI external_service.BillingAPI,
) domain_event.EventHandler {
	return &callOrderCreateSagaWhenOrderCreatedHandler{
		rep:        rep,
		orderSVC:   orderSVC,
...
func (h *callOrderCreateSagaWhenOrderCreatedHandler) Handler(ctx context.Context, mes *message.Message) error {
