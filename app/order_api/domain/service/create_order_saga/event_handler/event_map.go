...
var EventMap = map[message.Type]func() domain_event.CreateOrderSagaEventHandler{
	...
	message.Type_TYPE_EVENT_CARD_AUTHORIZATION_FAILED: NewNextStepSagaWhenTicketCreationFailedHandler,
}
