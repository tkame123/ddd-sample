...
func NewNextStepSagaWhenTicketApprovedHandler(rep repository.Repository) domain_event.CreateOrderSagaEventHandler {
	return &NextStepSagaWhenTicketApprovedHandler{rep: rep}
}

func (h *NextStepSagaWhenTicketApprovedHandler) Handler(ctx context.Context, sagaFactory domain_event.SagaFactory, mes *message.Message) error {
