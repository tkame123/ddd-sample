...
func NewNextStepSagaWhenOrderApprovedHandler(rep repository.Repository) domain_event.CreateOrderSagaEventHandler {
	return &NextStepSagaWhenOrderApprovedHandler{rep: rep}
}

func (h *NextStepSagaWhenOrderApprovedHandler) Handler(ctx context.Context, sagaFactory domain_event.SagaFactory, mes *message.Message) error {
