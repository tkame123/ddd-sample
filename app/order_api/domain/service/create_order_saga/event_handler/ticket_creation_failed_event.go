...
func NewNextStepSagaWhenTicketCreationFailedHandler(rep repository.Repository) domain_event.CreateOrderSagaEventHandler {
	return &NextStepSagaWhenTicketCreationFailedHandler{rep: rep}
}

func (h *NextStepSagaWhenTicketCreationFailedHandler) Handler(ctx context.Context, sagaFactory domain_event.SagaFactory, mes *message.Message) error {
