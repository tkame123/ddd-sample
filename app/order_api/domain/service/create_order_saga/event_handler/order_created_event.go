...
func NewNextStepSagaWhenOrderCreatedHandler(rep repository.Repository) domain_event.CreateOrderSagaEventHandler {
	return &NextStepSagaWhenOrderCreatedHandler{rep: rep}
}

func (h *NextStepSagaWhenOrderCreatedHandler) Handler(ctx context.Context, sagaFactory domain_event.SagaFactory, mes *message.Message) error {
